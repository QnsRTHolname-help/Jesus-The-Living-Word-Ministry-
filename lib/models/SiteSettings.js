...
const SiteSettingsSchema = new mongoose.Schema(
  {
    ...
    navigationLinks: { type: [NavigationLinkSchema], default: [] },
    ...
    contactIntro: {
      type: String,
      default: "Reach out for retreat registration, speaking invitations, prayer, or partnership."
    },
    contactSuccessMessage: {
      type: String,
      default: "Your message has been received. Our team will respond soon."
    },
    ...
    autoresponderSubject: { type: String, default: "We received your message" },
    autoresponderBody: {
      type: String,
      default: "Thank you for reaching out. Our ministry team has received your message and will respond soon."
    },
    ...
    accentColor: { type: String, default: "#d8b86a" },
    fontStyle: { type: String, enum: ["classic", "modern", "editorial"], default: "classic" }
  },
  { timestamps: true }
);
